...
let address: [Bible] = [
    ...
    Bible( title: "오바댜", label: "오바댜", value: "오바댜", pg: 1, version: "구약", initial: "oba", enTitle: "Obadiahs"),
...
//    Bible(title: "요한복음", label: "요한복음", value: "요한복음", pg: 21, version: "신약", initial: "joh",enTitle:"John"),
  ...
  Bible(title: "골로새서", label: "골로새서", value: "골로새서", pg: 4, version: "신약", initial: "col",enTitle:"Colossians"),
    ...
    Bible(title: "디모데후서", label: "디모데후서", value: "디모데후서", pg: 4, version: "신약", initial: "ti2",enTitle:"2 Timothy"),
  ...
  Bible(title: "요한3서", label: "요한3서", value: "요한3서", pg: 1, version: "신약", initial: "jo3",enTitle:"3 John"),
    ...
    Bible(title:"유다서",label:"유다서",value: "유다서",pg:1,version: "신약",initial: "jud",enTitle:"Jude"),
